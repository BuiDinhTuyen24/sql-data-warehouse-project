...
=====================================================================================
Scripts purpose:
    This scripts perform the ETL (extract, transform, load) process to load the tables
    from the tables in bronze layer to the silver layer with standardized information
  Actions performed:
    - Truncate all the tables existed in the silver layer
    - Insert transformed data to the tables in the silver layer
  Parameter: None
  This stored procedure does not return any values or accept any parameters
